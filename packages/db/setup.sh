...
# create demo user with email: demo@omnivore.app, password: demodemo
USER_ID=$(uuidgen)
PASSWORD='$2a$10$mNsL6PYHBMtITU6HktpbLOU.pYohiytmNwnVdeYUSpKUv61.EUdL.'
...
echo "created demo user with email: demo@omnivore.app, password: demodemo"
